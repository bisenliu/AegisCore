...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "github_com_aegiscore_user-services_internal_features_user_api.CreateUserRequest": {
            ...
            "properties": {
                ...
                "status": {
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_aegiscore_user-services_internal_features_user_domain.UserStatus"
                        }
                    ],
                    "example": 100
                },
        ...
        "github_com_aegiscore_user-services_internal_features_user_domain.UserStatus": {
            "type": "integer",
            "format": "int64",
            "enum": [
                100,
