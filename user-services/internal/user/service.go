...
func (s *service) ListUsers(ctx context.Context, query ListUsersQuery) (response.PaginatedData[UserResponse], error) {
	...
	if err != nil {
		...
		return response.PaginatedData[UserResponse]{}, response.FromError(err)
	}
