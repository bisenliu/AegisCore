...
| `request-validation` | 为 Gin controller 提供统一请求绑定、结构体校验、字段明细和校验失败响应 | `common/validation/`, `common/http/ginvalidation/`, `user-services/internal/validators/`, `user-services/internal/controller/user_controller.go`, `user-services/internal/bootstrap/bootstrap.go` | `openspec/specs/request-validation/spec.md` | ready |
