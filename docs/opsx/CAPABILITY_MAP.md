...
| `delivery-operations` | 构建、测试、lint、OpenAPI 生成、Ent/Atlas migration、运行时镜像、migration 镜像、Docker、Compose、Kubernetes、Helm 和发布顺序 | `Makefile`、`user-service/Makefile`、`user-service/scripts/`、`tools/openapi-convert/`、`deployments/` | `openspec/specs/delivery-operations/spec.md` | ready |
...
- `delivery-operations` 横跨 Makefile、脚本、仓库级工具、Ent、Atlas、OpenAPI、运行时镜像、migration 镜像、Docker、Compose、Kubernetes、Helm 和发布说明。
