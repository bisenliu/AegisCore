...
- **AND** public provider MUST 只暴露 controller、authorizer、route registrar、health/status、运行时聚合对象和 application port 等稳定 contract，父 module MUST NOT 消费 feature infrastructure concrete implementation
