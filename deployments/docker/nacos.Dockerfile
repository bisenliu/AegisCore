...
# - NACOS_AUTH_ENABLE：是否开启 SDK/gRPC Client 请求鉴权；本地开发关闭。
# - NACOS_AUTH_ADMIN_ENABLE：是否开启 /v3/admin/* Admin API 鉴权；本地初始化需要关闭。
# - NACOS_AUTH_CONSOLE_ENABLE：是否开启 /v3/console/* Console API 和登录鉴权；本地控制台操作需要关闭。
...
#   -e NACOS_AUTH_CONSOLE_ENABLE=false \
