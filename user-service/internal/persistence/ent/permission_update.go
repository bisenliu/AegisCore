...
func (_u *PermissionUpdate) SetPathTemplate(v string) *PermissionUpdate {
	_u.mutation.SetPathTemplate(v)
	return _u
}

// SetNillablePathTemplate sets the "path_template" field if the given value is not nil.
func (_u *PermissionUpdate) SetNillablePathTemplate(v *string) *PermissionUpdate {
	if v != nil {
...
func (_u *PermissionUpdate) AddRolePermissionIDs(ids ...int64) *PermissionUpdate {
...
func (_u *PermissionUpdate) RemoveRolePermissionIDs(ids ...int64) *PermissionUpdate {
...
func (_u *PermissionUpdate) check() error {
	...
	if v, ok := _u.mutation.PathTemplate(); ok {
...
// SetPathTemplate sets the "path_template" field.
func (_u *PermissionUpdateOne) SetPathTemplate(v string) *PermissionUpdateOne {
	_u.mutation.SetPathTemplate(v)
	return _u
}
...
// AddRolePermissionIDs adds the "role_permissions" edge to the RolePermission entity by IDs.
func (_u *PermissionUpdateOne) AddRolePermissionIDs(ids ...int64) *PermissionUpdateOne {
	_u.mutation.AddRolePermissionIDs(ids...)
	return _u
}
...
// RemoveRolePermissionIDs removes the "role_permissions" edge to RolePermission entities by IDs.
func (_u *PermissionUpdateOne) RemoveRolePermissionIDs(ids ...int64) *PermissionUpdateOne {
	_u.mutation.RemoveRolePermissionIDs(ids...)
	return _u
}
