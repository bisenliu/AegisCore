...
func (_c *RoleCreate) SetActive(v bool) *RoleCreate {
	_c.mutation.SetActive(v)
	return _c
}

// SetNillableActive sets the "active" field if the given value is not nil.
func (_c *RoleCreate) SetNillableActive(v *bool) *RoleCreate {
	if v != nil {
		_c.SetActive(*v)
	}
	return _c
...
func (_c *RoleCreate) AddRolePermissionIDs(ids ...int64) *RoleCreate {
