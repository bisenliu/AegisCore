...
const (
	// Label holds the string label denoting the rbacpolicyrevision type in the database.
	...
	// Table holds the table name of the rbacpolicyrevision in the database.
	Table = "rbac_policy_revisions"
