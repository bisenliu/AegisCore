...
func (r *SessionStore) GetCachedTokenVersion(ctx context.Context, userID uuid.UUID) (int64, error) {
...
func (r *SessionStore) CacheTokenVersion(ctx context.Context, userID uuid.UUID, tokenVersion int64) error {
...
func (r *SessionStore) DeleteCachedTokenVersion(ctx context.Context, userID uuid.UUID) error {
