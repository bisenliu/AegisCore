...
//
//	mockgen -destination=mock_policy_sync_test.go -package=application github.com/aegiscore/user-service/internal/features/permission/application PolicyReloadEngine,Metrics
//
...
func (m *MockPolicyReloadEngine) ProjectionStatus() PolicyProjectionStatus {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ProjectionStatus")
	ret0, _ := ret[0].(PolicyProjectionStatus)
	return ret0
}
