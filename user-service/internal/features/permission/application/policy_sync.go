...
type PolicyChangeNotifier interface {
	NotifyPolicyChanged(ctx context.Context, change PolicyChange)
}
...
func (c *PolicyRefreshCoordinator) NotifyPolicyChanged(ctx context.Context, change PolicyChange) {
	if c == nil {
		return
	}
