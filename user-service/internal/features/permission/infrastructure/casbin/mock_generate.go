...
//go:generate go tool mockgen -destination=mock_metrics_test.go -package=casbin github.com/aegiscore/user-service/internal/features/permission/infrastructure/casbin ReloadMetrics
